...
Allows Vivek Jaiswal to manage all SQLite database records from the browser.
...
async def admin_dashboard(
    ...
    """Main administrative dashboard with counts and stats."""
    ...
    queries_count = db.query(AIAgentQuery).count()
...
async def admin_profile_view(
    ...
    return templates.TemplateResponse(
        ...
        context={"admin_user": admin_user, "profile": profile, "msg": None},
    )
...
async def admin_profile_save(
    ...
    return templates.TemplateResponse(
        request=request,
        name="admin/profile.html",
        context={"admin_user": admin_user, "profile": profile, "msg": "Profile details updated successfully!"},
    )
...
async def admin_experiences_view(
    ...
    return templates.TemplateResponse(
        ...
        context={"admin_user": admin_user, "experiences": experiences},
    )
...
async def admin_skills_view(
    ...
    return templates.TemplateResponse(
        ...
        context={"admin_user": admin_user, "categories": categories},
    )
...
async def admin_projects_view(
    ...
    return templates.TemplateResponse(
        ...
        context={"admin_user": admin_user, "projects": projects},
    )
...
async def admin_reseed_database(
    ...
    """Re-seed SQLite database with resume defaults."""
